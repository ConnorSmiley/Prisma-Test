    ...
    <>
      ...
      <GoLiteContainer>
        <GoLiteStyle>
          ...
          <Title>
            SnackleMouth Granola
          </Title>

          <About>
            Snackle Mouth is a healthy granola company.
          </About>
          <About>
            Worked on design and preparing the images for print.
          </About>
...
export const getStaticProps = async () => {
  const { data: pic } = await supabase.from("SnackleMouth").select("*");
  return {
    props: {
      pic
    }
